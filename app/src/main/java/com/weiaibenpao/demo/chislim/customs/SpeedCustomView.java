...
public class SpeedCustomView extends DemoView {
    ...
    public SpeedCustomView(Context context, AttributeSet attrs){
        super(context, attrs);
        initView();
    }

    public SpeedCustomView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void chartRender()
    {
        try {
            ...
            //标题
            chart.setTitle("步频曲线");
            chart.getAxisTitle().setLeftTitle("步频：步");
            ...
            //坐标系
            //数据轴最大值
           /* chart.getDataAxis().setAxisMax(1.5);
    ...
    private void chartDataSet()
    {
       ...
       /* List<PointD> linePoint2 = new ArrayList<PointD>();
        ...
        linePoint3.add(new PointD(0d, 0d));
        linePoint3.add(new PointD(1d, 0.5d));
        linePoint3.add(new PointD(2d, 0.7d));
        linePoint3.add(new PointD(3d, 1d));
        linePoint3.add(new PointD(4d, 1.5d));
        linePoint3.add(new PointD(5d, 0.5d));
        linePoint3.add(new PointD(6d, 0.9d));
    ...
    public void setSpeedLinePoint(List<PointD> linePoint3, double max, double equity) {
    ...
    private void chartDesireLines()
    {
       /* CustomLineData s = new CustomLineData("GO",15d,Color.rgb(54, 141, 238),3);
        ...
        CustomLineData s3 = new CustomLineData("",16d, Color.rgb(77, 184, 73),3);
