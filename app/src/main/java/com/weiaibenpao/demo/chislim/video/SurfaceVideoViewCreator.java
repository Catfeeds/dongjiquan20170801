        ...
        MediaPlayer.OnInfoListener
{
    ...
    public SurfaceVideoViewCreator(Activity activity, ViewGroup container)
    {
        View view = LayoutInflater
                .from(activity)
                .inflate(com.weiaibenpao.demo.chislim.R.layout.surface_video_view_layout,container,false);

        container.addView(view);

        surfaceVideoView = (SurfaceVideoView) view.findViewById(com.weiaibenpao.demo.chislim.R.id.surface_video_view);
        progressBar      = (LoadingCircleView) view.findViewById(com.weiaibenpao.demo.chislim.R.id.surface_video_progress);
        statusButton     = (Button) view.findViewById(com.weiaibenpao.demo.chislim.R.id.surface_video_button);
        surface_video_screenshot = (ImageView) view.findViewById(com.weiaibenpao.demo.chislim.R.id.surface_video_screenshot);
        ...
        view.findViewById(com.weiaibenpao.demo.chislim.R.id.surface_video_container).getLayoutParams().height
                = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_PX, geturfaceHeight(), container.getContext().getResources().getDisplayMetrics());
        view.findViewById(com.weiaibenpao.demo.chislim.R.id.surface_video_container).requestLayout();
