...
public class HeartCustomView extends DemoView {
    ...
    public HeartCustomView(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
        initView();
    }

    public HeartCustomView(Context context, AttributeSet attrs){
        super(context, attrs);
        initView();
    }

    public HeartCustomView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void chartRender()
    {
        try {
            ...
            //标题
            chart.setTitle("配速曲线");
            //chart.addSubtitle("(平均配速)");
            chart.getAxisTitle().setLeftTitle("配速：Km/h");
            //chart.getAxisTitle().setRightTitle("时间：分钟");
    ...
    private void chartDataSet()
    {
       ...
       /* List<PointD> linePoint2 = new ArrayList<PointD>();
        ...
        linePoint3.add(new PointD(1d, 120d));
        ...
        linePoint3.add(new PointD(6d, 130d));
        SplineData dataSeries3 = new SplineData("Java",linePoint3,
                Color.rgb(177, 104, 63) );
    ...
    public void setHeartLinePoint(List<PointD> linePoint3, double max, double equity) {
    ...
    private void chartDesireLines()
    {
       /* CustomLineData s = new CustomLineData("GO",15d,Color.rgb(54, 141, 238),3);
        ...
        CustomLineData s3 = new CustomLineData("",16d, Color.rgb(177, 104, 63),3);

        s3.getLineLabelPaint().setColor(Color.rgb(177, 104, 63));
