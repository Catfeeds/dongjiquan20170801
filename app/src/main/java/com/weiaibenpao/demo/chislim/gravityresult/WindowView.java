package com.weiaibenpao.demo.chislim.gravityresult;
...
import com.weiaibenpao.demo.chislim.gravityresult.sensor.TiltSensor;

/**
 * An ImageView that automatically pans in response to device tilt.
 * Currently only supports {@link ScaleType#CENTER_CROP}.
 */
