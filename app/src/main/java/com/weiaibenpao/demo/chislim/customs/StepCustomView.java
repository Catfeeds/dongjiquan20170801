...
public class StepCustomView extends DemoView {
    ...
    private static List<CustomLineData> mCustomLineDataset = new LinkedList<CustomLineData>();
    ...
    public StepCustomView(Context context) {
        super(context);
        initView();
    ...
    public StepCustomView(Context context, AttributeSet attrs){
        super(context, attrs);
        initView();
    }

    public StepCustomView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void chartRender()
    {
        try {
            ...
            //标题
            chart.setTitle("步幅曲线");
            chart.getAxisTitle().setLeftTitle("步幅：厘米");
    ...
    private  void chartDataSet()
    {
        ...
        List<PointD> linePoint3 = new ArrayList<PointD>();
            ...
            SplineData dataSeries3 = new SplineData("Java",linePoint3,
                    Color.rgb(123, 120, 73) );
            linePoint3.add(new PointD(0d, 50d));
            linePoint3.add(new PointD(1d, 30d));
            linePoint3.add(new PointD(2d, 175d));
            linePoint3.add(new PointD(3d, 114d));
            linePoint3.add(new PointD(4d, 65d));
            linePoint3.add(new PointD(5d, 70d));
            linePoint3.add(new PointD(6d, 83d));
    ...
    public void setStepLinePoint(List<PointD> linePoint3) {
        ...
        //坐标系
        //数据轴最大值
        chart.getDataAxis().setAxisMax(160);
        //chart.getDataAxis().setAxisMin(0);
        //数据轴刻度间隔
    ...
    private  void chartDesireLines()
    {
        ...
        CustomLineData s3 = new CustomLineData("",16d, Color.rgb(123, 120, 73),3);

        s3.getLineLabelPaint().setColor(Color.rgb(123, 120, 73));
